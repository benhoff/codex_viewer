...
def build_synthetic_session(
    *,
    ...
    return ParsedSession(
        ...
        latest_context_window=rollups["latest_context_window"],
        latest_context_remaining_percent=rollups["latest_context_remaining_percent"],
        latest_primary_limit_used_percent=rollups["latest_primary_limit_used_percent"],
        latest_primary_limit_resets_at=rollups["latest_primary_limit_resets_at"],
        latest_secondary_limit_used_percent=rollups["latest_secondary_limit_used_percent"],
